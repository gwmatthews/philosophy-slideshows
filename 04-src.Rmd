...
- Just like we'd be wrong to seek something called "the desert" alongside of all of the cactus, lizards and sand in Nevada, we are mistaken to look for a thing called a "mind" alongside our bodily parts.
...
- Behaviorists claimed that more important than "looking inside" and observing our minds was studying how creatures *with* minds behaved, and ultimately being able to predict and control their behavior.
...
- This led to the philosophical view that minds just *were* certain kinds of behavior, and that any talk about minds from the "first person" was not to be trusted.
...
"It makes no sense to say minds result from the brains information processing activity."
...
Can we build a machine that should count as truly intelligent?
